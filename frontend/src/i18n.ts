const zh: Record<string, string> = {
  ...
  'plan.dialog_title': 'Plan 对话',
  'plan.chat_placeholder': '输入你的想法或反馈...',
  'plan.send': '发送',
  'plan.thinking': 'Claude 思考中...',
  'plan.streaming': '正在生成...',
  'card.view_log': '查看日志',
  'card.retry': '重试',
  'card.cancel': '取消',
  ...
  'workers.system_log': '系统日志',
  'workers.no_events': '暂无系统事件',
  // Project status
...
const en: Record<string, string> = {
  ...
  'plan.dialog_title': 'Plan Dialog',
  'plan.chat_placeholder': 'Type your thoughts or feedback...',
  'plan.send': 'Send',
  'plan.thinking': 'Claude is thinking...',
  ...
  'workers.system_log': 'System Log',
  'workers.no_events': 'No system events yet',
  // Project status
